...
/*AUDITORIA INSTRUMENTO_EVALUACION*/
DROP TRIGGER IF EXISTS `roducdb`. `AUDITORIA_INSERT_INSTRUMENTO_EVALUACION`;
DELIMITER $$
USE `roducdb` $$
CREATE TRIGGER `roducdb`.`AUDITORIA_INSERT_INSTRUMENTO_EVALUACION` BEFORE INSERT ON `roducweb_instrumento_evaluacion` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
		accion,
	...
	VALUES(
		...
		'I',
		NULL,
		CONCAT('Codigo: ', (SELECT `AUTO_INCREMENT` FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'roducdb' AND TABLE_NAME = 'roducweb_instrumento_evaluacion'), '| Descripcion:', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha),
		NEW.alta_usuario,
		NOW()
	);
END$$
...
DROP TRIGGER IF EXISTS `roducdb`.`AUDITORIA_UPDATE_INSTRUMENTO_EVALUACION`;
DELIMITER $$
USE `roducdb`$$
CREATE TRIGGER `roducdb`.`AUDITORIA_UPDATE_INSTRUMENTO_EVALUACION` BEFORE UPDATE ON `roducweb_instrumento_evaluacion` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
        accion,
    ...
    VALUES(
		'Instrumento Evaluación',
        (IF(NEW.estado = 0 AND OLD.estado = 1, 'D', 'U')),
		CONCAT('Codigo: ', OLD.cod_instrumento_evaluacion, '| Descripcion: ', OLD.descripcion, '| Estado: ', OLD.estado, '| Usuario Alta: ', OLD.alta_usuario, '| Fecha Alta: ', OLD.alta_fecha, '| Modif. Usuario: ', OLD.modif_usuario, '| Modif. Fecha: ', OLD.modif_fecha),
		CONCAT('Codigo: ', NEW.cod_instrumento_evaluacion, '| Descripcion: ', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha, '| Modif. Usuario: ', NEW.modif_usuario, '| Modif. Fecha: ', NEW.modif_fecha),
        NEW.modif_usuario,
        NOW()
    );
END$$
...
/*AUDITORIA METODOLOGIA_ENSEÑANZA*/
DROP TRIGGER IF EXISTS `roducdb`. `AUDITORIA_INSERT_METODOLOGIA_ENSEÑANZA`;
DELIMITER $$
USE `roducdb` $$
CREATE TRIGGER `roducdb`.`AUDITORIA_INSERT_METODOLOGIA_ENSEÑANZA` BEFORE INSERT ON `roducweb_metodologia_enseñanza` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
		accion,
	...
	VALUES(
		...
		'I',
		NULL,
		CONCAT('Codigo: ', (SELECT `AUTO_INCREMENT` FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'roducdb' AND TABLE_NAME = 'roducweb_metodologia_enseñanza'), '| Descripcion:', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha),
		NEW.alta_usuario,
		NOW()
	);
END$$
...
DROP TRIGGER IF EXISTS `roducdb`.`AUDITORIA_UPDATE_METODOLOGIA_ENSEÑANZA`;
DELIMITER $$
USE `roducdb`$$
CREATE TRIGGER `roducdb`.`AUDITORIA_UPDATE_METODOLOGIA_ENSEÑANZA` BEFORE UPDATE ON `roducweb_metodologia_enseñanza` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
        accion,
    ...
    VALUES(
		'Metodologia de Enseñanza',
        (IF(NEW.estado = 0 AND OLD.estado = 1, 'D', 'U')),
		CONCAT('Codigo: ', OLD.cod_metodologia_enseñanza, '| Descripcion: ', OLD.descripcion, '| Estado: ', OLD.estado, '| Usuario Alta: ', OLD.alta_usuario, '| Fecha Alta: ', OLD.alta_fecha, '| Modif. Usuario: ', OLD.modif_usuario, '| Modif. Fecha: ', OLD.modif_fecha),
		CONCAT('Codigo: ', NEW.cod_metodologia_enseñanza, '| Descripcion: ', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha, '| Modif. Usuario: ', NEW.modif_usuario, '| Modif. Fecha: ', NEW.modif_fecha),
        NEW.modif_usuario,
        NOW()
    );
END$$
...
/*AUDITORIA RECURSOS_AUXILIAR*/
DROP TRIGGER IF EXISTS `roducdb`. `AUDITORIA_INSERT_RECURSOS_AUXILIAR`;
DELIMITER $$
USE `roducdb` $$
CREATE TRIGGER `roducdb`.`AUDITORIA_INSERT_RECURSOS_AUXILIAR` BEFORE INSERT ON `roducweb_recursos_auxiliar` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
		accion,
	...
	VALUES(
		...
		'I',
		NULL,
		CONCAT('Codigo: ', (SELECT `AUTO_INCREMENT` FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'roducdb' AND TABLE_NAME = 'roducweb_recursos_auxiliar'), '| Descripcion:', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha),
		NEW.alta_usuario,
		NOW()
	);
END$$
...
DROP TRIGGER IF EXISTS `roducdb`.`AUDITORIA_UPDATE_RECURSOS_AUXILIAR`;
DELIMITER $$
USE `roducdb`$$
CREATE TRIGGER `roducdb`.`AUDITORIA_UPDATE_RECURSOS_AUXILIAR` BEFORE UPDATE ON `roducweb_recursos_auxiliar` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
        accion,
    ...
    VALUES(
		'Recursos Auxiliares',
        (IF(NEW.estado = 0 AND OLD.estado = 1, 'D', 'U')),
		CONCAT('Codigo: ', OLD.cod_recurso_auxiliar, '| Descripcion: ', OLD.descripcion, '| Estado: ', OLD.estado, '| Usuario Alta: ', OLD.alta_usuario, '| Fecha Alta: ', OLD.alta_fecha, '| Modif. Usuario: ', OLD.modif_usuario, '| Modif. Fecha: ', OLD.modif_fecha),
		CONCAT('Codigo: ', NEW.cod_recurso_auxiliar, '| Descripcion: ', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha, '| Modif. Usuario: ', NEW.modif_usuario, '| Modif. Fecha: ', NEW.modif_fecha),
        NEW.modif_usuario,
        NOW()
    );
END$$
...
/*AUDITORIA RECURSOS_AUXILIAR*/
DROP TRIGGER IF EXISTS `roducdb`. `AUDITORIA_INSERT_TIPO_EVA`;
DELIMITER $$
USE `roducdb` $$
CREATE TRIGGER `roducdb`.`AUDITORIA_INSERT_TIPO_EVA` BEFORE INSERT ON `roducweb_tipo_eva` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
		accion,
	...
	VALUES(
		...
		'I',
		NULL,
		CONCAT('Codigo: ', (SELECT `AUTO_INCREMENT` FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'roducdb' AND TABLE_NAME = 'roducweb_tipo_eva'), '| Descripcion:', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha),
		NEW.alta_usuario,
		NOW()
	);
END$$
...
DROP TRIGGER IF EXISTS `roducdb`.`AUDITORIA_UPDATE_TIPO_EVA`;
DELIMITER $$
USE `roducdb`$$
CREATE TRIGGER `roducdb`.`AUDITORIA_UPDATE_TIPO_EVA` BEFORE UPDATE ON `roducweb_tipo_eva` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
        accion,
    ...
    VALUES(
		'Tipo Evaluación',
        (IF(NEW.estado = 0 AND OLD.estado = 1, 'D', 'U')),
		CONCAT('Codigo: ', OLD.cod_tipo_eva, '| Descripcion: ', OLD.descripcion, '| Estado: ', OLD.estado, '| Usuario Alta: ', OLD.alta_usuario, '| Fecha Alta: ', OLD.alta_fecha, '| Modif. Usuario: ', OLD.modif_usuario, '| Modif. Fecha: ', OLD.modif_fecha),
		CONCAT('Codigo: ', NEW.cod_tipo_eva, '| Descripcion: ', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha, '| Modif. Usuario: ', NEW.modif_usuario, '| Modif. Fecha: ', NEW.modif_fecha),
        NEW.modif_usuario,
        NOW()
    );
END$$
...
/*AUDITORIA RECURSOS_AUXILIAR*/
DROP TRIGGER IF EXISTS `roducdb`. `AUDITORIA_INSERT_TRABAJO_AUTONOMO`;
DELIMITER $$
USE `roducdb` $$
CREATE TRIGGER `roducdb`.`AUDITORIA_INSERT_TRABAJO_AUTONOMO` BEFORE INSERT ON `roducweb_trabajo_autonomo` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
		accion,
	...
	VALUES(
		...
		'I',
		NULL,
		CONCAT('Codigo: ', (SELECT `AUTO_INCREMENT` FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'roducdb' AND TABLE_NAME = 'roducweb_trabajo_autonomo'), '| Descripcion:', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha),
		NEW.alta_usuario,
		NOW()
	);
END$$
...
DROP TRIGGER IF EXISTS `roducdb`.`AUDITORIA_UPDATE_TRABAJO_AUTONOMO`;
DELIMITER $$
USE `roducdb`$$
CREATE TRIGGER `roducdb`.`AUDITORIA_UPDATE_TRABAJO_AUTONOMO` BEFORE UPDATE ON `roducweb_trabajo_autonomo` FOR EACH ROW
BEGIN
	INSERT INTO roducweb_auditoria(
		tabla,
        accion,
    ...
    VALUES(
		'Trabajo Autónomo',
        (IF(NEW.estado = 0 AND OLD.estado = 1, 'D', 'U')),
		CONCAT('Codigo: ', OLD.cod_trabajo_autonomo, '| Descripcion: ', OLD.descripcion, '| Estado: ', OLD.estado, '| Usuario Alta: ', OLD.alta_usuario, '| Fecha Alta: ', OLD.alta_fecha, '| Modif. Usuario: ', OLD.modif_usuario, '| Modif. Fecha: ', OLD.modif_fecha),
		CONCAT('Codigo: ', NEW.cod_trabajo_autonomo, '| Descripcion: ', NEW.descripcion, '| Estado: ', NEW.estado, '| Usuario Alta: ', NEW.alta_usuario, '| Fecha Alta: ', NEW.alta_fecha, '| Modif. Usuario: ', NEW.modif_usuario, '| Modif. Fecha: ', NEW.modif_fecha),
        NEW.modif_usuario,
        NOW()
    );
END$$
